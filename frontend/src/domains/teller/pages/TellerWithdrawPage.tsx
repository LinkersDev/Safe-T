...
import { tellerWithdraw } from '../services/teller-service'
import { normalizeApiError } from '../../../core/api/error-normalizer'

export function TellerWithdrawPage() {
  ...
  const mutation = useMutation({
    mutationFn: tellerWithdraw,
    onSuccess: () => toast.success('Withdrawal processed.'),
