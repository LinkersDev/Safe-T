...
class FraudAlertAdmin(admin.ModelAdmin):
    list_display   = ("id", "alert_type", "severity", "status", "risk_score", "user", "created_at")
    list_filter    = ("severity", "status", "alert_type")
    search_fields  = ("user__phone_number", "user__full_name")
    readonly_fields = ("created_at", "updated_at", "reviewed_at", "auto_action_taken", "rules_triggered")
